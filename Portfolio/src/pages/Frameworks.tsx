...
import { FaTerminal, FaExternalLinkAlt, FaBoxOpen } from "react-icons/fa";
    ...
    return (
        <div className="flex items-center justify-center w-full h-full p-4 md:p-8">
            <motion.div
                ...
                className="w-full max-w-6xl bg-black/40 backdrop-blur-xl rounded-lg shadow-2xl overflow-hidden border border-white/10 flex flex-col h-[85vh]"
            >
                {/* Terminal Header */}
                ...
                <div className="flex flex-col md:flex-row flex-grow overflow-hidden">
                    ...
                    <div className="w-full md:w-2/3 flex flex-col bg-black/10 relative overflow-hidden">
                        <div className="p-3 border-b border-white/5 bg-white/5 text-xs font-mono text-gray-400 uppercase tracking-wider flex justify-between">
